        ...
        where TParameter : IDataParameter, IDbDataParameter, new()
    {
        ...
        public override bool Create(LaborEntity entity)
        {
            string commandText = string.Format(@"Insert Into [XQYCLabor] (
                    ...
                    [CurrentContractKey],
                    [CurrentInsuranceFormularKey],
                    [CurrentReserveFundFormularKey],
                    [CurrentManageFeeFormularKey],
			        [Memo1],
			        [Memo2],
			        [Memo3],
			        [Memo4],
                ...
                Values (
                    ...
                    {0}CurrentInsuranceFormularKey,
                    {0}CurrentReserveFundFormularKey,
                    {0}CurrentManageFeeFormularKey,
			        {0}Memo1,
			        {0}Memo2,
			        {0}Memo3,
			        {0}Memo4,
        ...
        public override bool Update(LaborEntity entity)
        {
            string commandText = string.Format(@"Update [XQYCLabor] Set   
                    ...
                    [CurrentInsuranceFormularKey] = {0}CurrentInsuranceFormularKey,
                    [CurrentReserveFundFormularKey] = {0}CurrentReserveFundFormularKey,
                    [CurrentManageFeeFormularKey] = {0}CurrentManageFeeFormularKey,
					[Memo1] = {0}Memo1,
					[Memo2] = {0}Memo2,
					[Memo3] = {0}Memo3,
					[Memo4] = {0}Memo4,
